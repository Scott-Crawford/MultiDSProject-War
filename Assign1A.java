/** Assign1A driver program.  This program must work as is with your
 ...
 *  be identical to the sample output, with the exception of the result of
...
public class Assign1A
{
	...
	{
		// Testing constructor
		PrimitiveQ<Integer> theQ = new MultiDS<Integer>(5);
		...
		int count = 1;
		PrimitiveQ<String> theQ2 = new MultiDS<String>(5);
